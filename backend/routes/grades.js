 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.post('/', authenticateToken, requirePermission('manage_grades'), validate(createGradeSchema), asyncHandler(createGradeWithAudit));
 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.post('/bulk', authenticateToken, requirePermission('manage_grades'), validate(bulkGradeSchema), asyncHandler(createBulkGradesWithAudit));
 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.put('/:id', authenticateToken, requirePermission('manage_grades'), validate(updateGradeSchema), asyncHandler(updateGradeWithAudit));
 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.delete('/:id', authenticateToken, requirePermission('manage_grades'), asyncHandler(deleteGradeWithAudit));
 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.get('/stats', authenticateToken, asyncHandler(getGradeStats));
