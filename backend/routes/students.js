 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.get('/:id/stats', authenticateToken, asyncHandler(getStudentStats));
 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.get('/:id', authenticateToken, asyncHandler(getStudent));
 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.post('/', authenticateToken, requirePermission('manage_students'), validate(createStudentSchema), asyncHandler(createStudentWithAudit));
 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.put('/:id', authenticateToken, requirePermission('manage_students'), validate(updateStudentSchema), asyncHandler(updateStudentWithAudit));
 ...
 *               $ref: '#/components/schemas/ErrorEnvelope'
 */
router.delete('/:id', authenticateToken, requirePermission('manage_students'), asyncHandler(deleteStudentWithAudit));
