...
DROP TABLE IF EXISTS parents CASCADE; -- Re-creating to link to new students
...
-- A specific course offered by a teacher for a grade level
CREATE TABLE IF NOT EXISTS offerings (
    ...
    -- Constraint: One active offering per subject/grade per teacher for a year
...
CREATE TABLE IF NOT EXISTS enrollments (
    ...
    -- Constraint: Student can be in one group per offering (handled via application logic or complex exclusion constraint)
...
-- Basic Policy: Teachers see their own data
-- (Detailed policies to be applied separately)
