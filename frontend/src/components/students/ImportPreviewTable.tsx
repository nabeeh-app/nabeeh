  ...
  return (
    <div className="space-y-4">
                  ...
                  >
                    ...
                    <td className="px-3 py-2">
                      ...
                      {row.warnings.length > 0 && (
                        <div className="text-xs text-warning">{row.warnings.join('; ')}</div>
                      )}
                    </td>
                  </tr>
                );
      ...
      <div className="flex gap-4 text-sm">
        <span className="text-success">{t('ready')}: {stats.ready}</span>
        <span className="text-warning">{t('warning')}: {stats.warning}</span>
        <span className="text-error">{t('error')}: {stats.error}</span>
      </div>
    </div>
  );
}
